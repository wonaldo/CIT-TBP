    ...
    for i, j in itr.product(nodes, repeat=2):
        ...
        # Causality from parents
            ...
            if p_value<threshold:
                ...
                # Significance test
                low_band, high_band = block_bootstrap(data[1:-1, [node_to_col_idx[i]]], data[2:, [node_to_col_idx[j]]], sep_set_ij, sep_set_ji, bandwidth, block_size=10, n_bootstrap=100, low_per=2.5, high_per=97.5)
